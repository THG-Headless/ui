...
**Primitive Varaibles** are core values to your components style. These will often be abstract variables, such as shades of a colour, or measurements of radius.
