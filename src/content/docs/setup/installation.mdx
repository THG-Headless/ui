...
Your all set! From here its up to you to use as little or as much of the package as you like, and by using a tool like Tailwind, any unused CSS will be pruned from your project at build time keeping your pages quick and lightweight.

_**So, whats next?**_

If you want to explore how to take our default themes and make them your own, then go ahead and get familiar with the Altitude Design System. Wether you need to get our styles inline with our current sites, or want to use the Altitude Design System as the basis for styling your site, we explain it all within the Design System Section of these docs. Click here to get started! **ADD LINK HERE**

Like what we have and want to get straight into integrating our components into your site, check out any of the component specific documentation examples to get the code, or click here for an overview of how component level customisation works **ADD LINK HERE**
