...
| `--modal-animation-speed`               | `var(--duration-speed-slow)`        | Duration of modal animations              |
| `--modal-surface`                       | `var(--color-surface-cards)`        | Background color for the modal            |
...
| `--modal-text-color`                    | `var(--color-text-black)`           | Default text color for the modal          |
...
| `--modal-text-body-color`               | `var(--color-text-medium-emphasis)` | Color for close button text               |
| `--modal-text-title-color`              | `var(--color-text-high-emphasis)`   | Color for close button text on hover      |
...
| `--modal-text-title-color`       | `var(--color-text-high-emphasis)`   | Color for modal title text      |
...
| `--modal-text-body-color`        | `var(--color-text-medium-emphasis)` | Color for modal body text       |
