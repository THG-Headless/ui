...
| `--modal-radius`                        | `var(--radius-none)`           | Border radius of the modal                |
...
| `--modal-text-color`                    | `var(--color-black)`           | Default text color for the modal          |
...
| `--modal-text-close-button-size`        | `var(--text-md)`               | Font size for close button                |
| `--modal-text-close-button-weight`      | `var(--font-normal)`           | Font weight for close button              |
| `--modal-text-close-button-line-height` | `var(--line-height-md)`        | Line height for close button              |
| `--modal-text-body-color`               | `var(--color-medium-emphasis)` | Color for close button text               |
| `--modal-text-title-color`              | `var(--color-high-emphasis)`   | Color for close button text on hover      |
...
| Variable                         | Default Value                  | Description                     |
| -------------------------------- | ------------------------------ | ------------------------------- |
| `--modal-text-title-size`        | `var(--text-md)`               | Font size for modal title       |
| `--modal-text-title-line-height` | `var(--line-height-md)`        | Line height for modal title     |
| `--modal-text-title-line-weight` | `var(--font-semi-bold)`        | Font weight for modal title     |
| `--modal-text-title-color`       | `var(--color-high-emphasis)`   | Color for modal title text      |
| `--modal-text-body-size`         | `var(--text-body)`             | Font size for modal body text   |
| `--modal-text-body-line-height`  | `var(--line-height-body)`      | Line height for modal body text |
| `--modal-text-body-line-weight`  | `var(--font-normal)`           | Font weight for modal body      |
| `--modal-text-body-color`        | `var(--color-medium-emphasis)` | Color for modal body text       |
