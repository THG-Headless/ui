...
| ------------------------------------- | --------------------------------------- | ------------------------------------- |
| `--dropdown-text-label-color`         | `var(--color-text-high-emphasis)`       | Color of the dropdown label           |
| `--dropdown-text-summary-color`       | `var(--color-text-high-emphasis)`       | Color of the dropdown summary text    |
| `--dropdown-text-helper-color`        | `var(--color-text-high-emphasis)`       | Color of the helper text              |
| `--dropdown-text-option-color`        | `var(--color-text-high-emphasis)`       | Color of the dropdown options         |
| `--dropdown-text-inactive-color`      | `var(--color-text-inactive)`            | Color for inactive dropdown text      |
| `--dropdown-text-error-color`         | `var(--color-text-error)`               | Color for error text                  |
| `--dropdown-text-search-color`        | `var(--color-text-medium-emphasis)`     | Color for search input placeholder    |
| `--dropdown-surface`                  | `var(--color-surface-white)`            | Background color of the dropdown      |
...
| `--dropdown-surface-hover`            | `var(--color-surface-primary-lightest)` | Background color on hover             |
| `--dropdown-surface-inactive`         | `var(--color-surface-white)`            | Background color for inactive state   |
| `--dropdown-border-color`             | `var(--color-border-controls)`          | Border color for the dropdown         |
| `--dropdown-border-color-hover`       | `var(--color-border-primary)`           | Border color on hover                 |
| `--dropdown-border-color-active`      | `var(--color-border-primary)`           | Border color when active              |
| `--dropdown-border-color-error`       | `var(--color-border-error)`             | Border color for error state          |
| `--dropdown-border-color-inactive`    | `var(--color-border-inactive)`          | Border color for inactive state       |
| `--dropdown-icon-color`               | `var(--color-icons-black)`              | Color of the dropdown icons           |
| `--dropdown-icon-error-color`         | `var(--color-icons-error)`              | Color of the error icon               |
...
| `--dropdown-focus-ring-color`        | `var(--color-border-attention)` | Color of the focus ring              |
