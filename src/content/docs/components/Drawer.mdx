...
| `--drawer-text-color`                    | `var(--color-text-black)`           | Default text color for the drawer               |
...
| `--drawer-text-body-color`               | `var(--color-text-medium-emphasis)` | Color for close button text                     |
| `--drawer-text-title-color`              | `var(--color-text-high-emphasis)`   | Color for close button text on hover            |
