...
| Variable                          | Default Value                      | Description                                  |
| --------------------------------- | ---------------------------------- | -------------------------------------------- |
| `--carousel-surface-image`        | `var(--color-surface-inactive)`    | Background color for carousel images         |
...
| `--carousel-surface-banner`       | `var(--color-surface-white)`       | Background color for banner items            |
| `--carousel-surface-banner-hover` | `var(--carousel-surface-banner)`   | Background color for banner items on hover   |
| `--carousel-border-hover`         | `var(--color-border-primary)`      | Border color on hover                        |
| `--carousel-border-active`        | `var(--color-border-primary)`      | Border color when active                     |
...
| Variable                            | Default Value                       | Description               |
| ----------------------------------- | ----------------------------------- | ------------------------- |
| `--carousel-text-color`             | `var(--color-text-black)`           | Default text color        |
| `--carousel-text-title-color`       | `var(--color-text-high-emphasis)`   | Color for titles          |
| `--carousel-text-body-color`        | `var(--color-text-medium-emphasis)` | Color for body text       |
...
| `--carousel-focus-outline` | `var(--color-border-attention)` | Color of the focus outline           |
