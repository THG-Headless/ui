...
<ShowComponent filePath='./src/components/accordion/NamedSummaryAccordion.html'>
  <div style={{'--accordion-gap': '0.5em', '--acc-panel-divider': 'none', '--accordion-radius': 'var(--radius-size-sm)', '--accordion-section-radius': 'var(--radius-size-sm)', '--acc-panel-border-top': 'none', '--acc-panel-border-bottom': 'none', '--accordion-box-shadow': 'var(--shadow-md)'  }}>
    <NamedSummaryAccordion />
  </div>
</ShowComponent>
