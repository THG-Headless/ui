...
<ShowComponent filePath='./src/components/accordion/NamedSummaryAccordion.html'>
  <div
    style={{
      ...
      '--accordion-radius': 'var(--radius-size-sm)',
      '--accordion-section-radius': 'var(--radius-size-sm)',
...
| `--accordion-trigger-text-color` | `var(--text-medium-emphasis)` | Text colour on the accordion trigger                   |
| `--accordion-text-size`          | `normal`                      |                                                        |
| `--accordion-content-text-color` | `var(--text-medium-emphasis)` | Text colour in the accordion panel                     |
...
| `--acc-panel-border-top`    | `var(--neutral-500) solid 2px;` | Top border of content panel         |
| `--acc-panel-border-bottom` | `var(--neutral-500) solid 2px;` | Bottom border of content panel      |
...
| `--acc-panel-divider`        | `var(--neutral-200) solid 2px` | Border division between panels             |
