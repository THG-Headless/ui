...
| `--accordion-trigger-text-color` | `var(--color-text-medium-emphasis)` | Text colour on the accordion trigger                   |
| `--accordion-text-size`          | `normal`                            |                                                        |
| `--accordion-content-text-color` | `var(--color-text-medium-emphasis)` | Text colour in the accordion panel                     |
