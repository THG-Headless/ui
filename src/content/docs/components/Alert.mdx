...
| Variable                           | Default Value                  | Description               |
| ---------------------------------- | ------------------------------ | ------------------------- |
| `--alert-text-success-color`       | `var(--color-text-success)`    | Text content colour       |
| `--alert-background-success-color` | `var(--color-surface-success)` | Background content colour |

#### Info Alert Variables

| Variable                        | Default Value                    | Description               |
| ------------------------------- | -------------------------------- | ------------------------- |
| `--alert-text-info-color`       | `var(--color-text-attention)`    | Text content colour       |
| `--alert-background-info-color` | `var(--color-surface-attention)` | Background content colour |

#### Error Alert Variables

| Variable                         | Default Value                | Description               |
| -------------------------------- | ---------------------------- | ------------------------- |
| `--alert-text-error-color`       | `var(--color-text-error)`    | Text content colour       |
| `--alert-background-error-color` | `var(--color-surface-error)` | Background content colour |
