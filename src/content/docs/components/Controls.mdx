...
| Variable                          | Default Value                       | Description                               |
| --------------------------------- | ----------------------------------- | ----------------------------------------- |
| `--control-btn-background`        | `var(--color-surface-white)`        | Background color of control buttons       |
| `--control-btn-color`             | `var(--color-icons-primary)`        | Color of control button icons             |
| `--control-btn-hover-color`       | `var(--color-icons-primary-darker)` | Color of control button icons on hover    |
| `--control-btn-active-color`      | `var(--color-icons-primary-darker)` | Color of control button icons when active |
